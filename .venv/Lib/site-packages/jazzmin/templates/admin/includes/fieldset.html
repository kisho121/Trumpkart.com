...
{% endif %}
    ...
    <div class="form-group{% if line.fields and line.fields|length_is:1 and line.errors %}
    errors
    {% endif %}
    {% if not line.has_visible_field %} hidden{% endif %}{% for field in line %}{% if field.field.name %} field-{{ field.field.name }}{% endif %}{% endfor %}">
